...
- Separat säkerhetsagent på egen fysisk hårdvara med read-only SSH och listen-only Matrix-klient — den observerar men kan inte agera, så en prompt injection saknar verkningsradie
